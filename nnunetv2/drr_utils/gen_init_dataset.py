...
LastEditTime: 2023-12-11 22:08:48
'''
...
class GenInitDRRMask:
    ...
    def gen_random_pose_parameters(self):
        ...
        rotations, translations = dataset_sample.Monte_Carlo_sample_dataset(self.rot_range_list, self.trans_range_list, self.num_samples)
